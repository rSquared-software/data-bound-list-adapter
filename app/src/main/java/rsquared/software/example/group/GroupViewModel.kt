...
class GroupViewModel : ViewModel() {
    ...
    val eventList = listOf(
        Event(id = 11, parentId = 0, name = "Romance Dawn"),
        ...
        Event(id = 10, parentId = 2, name = "Welcome to Wano"),
    ...
    val eventListCopy = listOf(
        ...
        EventsHeader(id = 3, groupId = 2, parentId = 1, name = "Epic parties"),
        Event(id = 4, parentId = 2, name = "Enies Lobby"),
        Event(id = 5, parentId = 2, name = "Welcome to Wano"),

        EventsHeader(id = 6, groupId = 3, name = "Birthdays"),
        Event(id = 7, parentId = 3, name = "Robin's birthday"),
        Event(id = 8, parentId = 3, name = "Nami's birthday"),
        Event(id = 9, parentId = 3, name = "Franky's birthday"),
        Event(id = 10, parentId = 3, name = "Zorro's birthday")
    )

    var lastReturned = eventList

    fun getTheOther(): List<Event>? {
        return if (lastReturned === eventList) {
            logVerbose("return copy")
            eventListCopy
        } else {
            logVerbose("return original")
            eventList
        }.also { lastReturned = it }
